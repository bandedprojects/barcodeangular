...
var AppDialogComponent = /** @class */ (function () {
    ...
    AppDialogComponent.prototype.save = function () {
        //this.dialogRef.close(this.form.value);
    };
    AppDialogComponent.prototype.close = function () {
        this.dialogRef.close('close');
    };
    AppDialogComponent.prototype.yes = function () {
        this.dialogRef.close('yes');
    };
    AppDialogComponent.ctorParameters = function () { return [
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, navListService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authSubscription = this.authService.authChange.subscribe(function (authChange) {
            _this.isAuth = authChange;
        });
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.navListSubscription = _this.navListService.navListChange.subscribe(function (navList) {
                _this.sideNav = navList.sidenav;
            });
        });
    };
...
/* harmony import */ var ngx_print__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-print */ "./node_modules/ngx-print/fesm5/ngx-print.js");
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.userService.login({
            ...
            if (responseData.status && responseData.status == '1') {
                _this.authService.login(responseData.data);
            }
            else {
                _this.loginError = "Login Failiure";
            }
        });
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.login = function (authData) {
...
var BarcodeComponent = /** @class */ (function () {
    function BarcodeComponent(batchService, dialog) {
    ...
    BarcodeComponent.prototype.ngOnInit = function () {
        ...
        this.batchService.getBatchList().subscribe(function (responseData) {
            if (responseData.status == "1") {
                _this.batchesList = responseData.data.batches;
            }
        });
    };
    BarcodeComponent.prototype.onSaveAndPrintClick = function () {
        var _this = this;
        this.serial_no = this.printBarcodeForm.value.serialnumber;
        var dialogConfig;
        var batch = this.batchesList.find(function (element) { return element.batchname == _this.printBarcodeForm.value.batchname; });
        var found = this.batchesList.find(function (element) { return (parseInt(element.serial_start) <= parseInt(_this.serial_no) && parseInt(element.serial_end) >= parseInt(_this.serial_no)); });
        if (batch) {
            if (found) {
                var data = {
                ...
                this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
                    ...
                    if (responseData.status == '1') {
                        ...
                        var rejected_batch = rejectionsList.find(function (element) { return element.serial_number == _this.serial_no; });
                        if (rejected_batch) {
                            dialogConfig = {
                                description: "Rejected Serial Number." + _this.serial_no
                            };
                    ...
                    _this.batchService.saveBarCode(_this.printBarcodeForm.value).subscribe(function (responseData) {
                        if (responseData.status == '1') {
                            ...
                            var dialogRef = _this.dialog.open(src_app_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AppDialogComponent"], {
                                data: dialogConfig
                            });
                            dialogRef.afterClosed().subscribe(function (result) {
                                if (result == 'yes') {
                                    _this.batchService.updateBarCode(_this.printBarcodeForm.value).subscribe(function (responseData) {
                                        if (responseData.status == '1') {
                                            dialogConfig = {
                                                description: "Success."
                                            };
...
var BatchComponent = /** @class */ (function () {
    function BatchComponent(batchService) {
        this.batchService = batchService;
    }
...
var BatchService = /** @class */ (function () {
    ...
    BatchService.prototype.getBatchDataSource = function () {
        this.batch = [
            {
                name: "test",
                sl_no_range: "100-200",
    ...
    BatchService.prototype.prepareReportDataSource = function (start, end, report, rejectionsList) {
        this.batchData = [];
        var batchItem;
        var status = "OK";
        ...
        for (var i = 0; i < col_length; i++) {
            ...
            var _loop_1 = function () {
                ...
                if (start_slno > end)
                    return "continue";
                var rejectedSerialNo = void 0;
                if (rejectionsList.length) {
                    rejectedSerialNo = rejectionsList.find(function (element) { return element.serial_number == start_slno; });
                }
                ...
                var status_key = "status" + j;
                batchItem = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, batchItem, (_a = {}, _a[serial_no_index] = start_slno, _a[status_key] = status, _a));
            };
            for (var j = 1; j <= 6; j++) {
                _loop_1();
            }
       ...
       let serial_number1 =  end_serial_no+1;
        ...
        for (var i = 0; i < col_length; i++) {
            ...
            for (var j = 1; j <= 6; j++) {
                ...
                batchItem = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, batchItem, (_a = {}, _a[serial_no_index] = start_slno, _a[status_key] = false, _a));
            }
            this.batchData.push(batchItem);
            ++start_row_sl_no;
        }
    ...
    BatchService.prototype.createBatch = function (data) {
        return this.http.post('/createbatch', data);
    };
    BatchService.prototype.getBatchList = function () {
        return this.http.get('/batches');
    };
    BatchService.prototype.getBatch = function (id) {
        return this.http.get('/batches/' + id);
    };
    BatchService.prototype.getLastSerial = function () {
        return this.http.get('/lastserial');
    };
    BatchService.prototype.rejectCylinder = function (data) {
        return this.http.post('/rejectcilinder', data);
    };
    BatchService.prototype.rejectedCylindersList = function (data) {
        return this.http.post('/rejectedcylinderlist', data);
    };
    BatchService.prototype.saveBarCode = function (data) {
        return this.http.post('/tareweight', data);
    };
    BatchService.prototype.updateBarCode = function (data) {
        return this.http.post('/tareweightupdate', data);
    };
    BatchService.prototype.tareweightCylindersList = function (data) {
...
var CreateBatchComponent = /** @class */ (function () {
    function CreateBatchComponent(batchService, dialog, router) {
        this.batchService = batchService;
        this.dialog = dialog;
        this.router = router;
        this.batchName = "";
    ...
    CreateBatchComponent.prototype.ngOnInit = function () {
        ...
        this.batchService.getLastSerial().subscribe(function (responseData) {
            if (responseData.data.lastserialnuber) {
                _this.lastSerialNumber = responseData.data.lastserialnuber;
    ...
    CreateBatchComponent.prototype.onSubmit = function () {
        ...
        this.batchService.createBatch(this.createBatchForm.value)
            ...
            var dialogRef = _this.dialog.open(_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AppDialogComponent"], {
                data: dialogConfig
            });
            dialogRef.afterClosed().subscribe(function (result) {
                _this.router.navigate(['/viewbatch']);
            });
        });
    };
    CreateBatchComponent.ctorParameters = function () { return [
...
var PrepareBatchComponent = /** @class */ (function () {
    function PrepareBatchComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
        this.batchName = "";
    ...
    PrepareBatchComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.batchService.getLastSerial().subscribe(function (responseData) {
            if (responseData.data.lastserialnuber) {
                ...
                _this.prepareBatchForm.get('starting_serial_no').disable();
            }
        });
    };
    PrepareBatchComponent.prototype.onSubmit = function () {
        var start = this.lastSerialNumber;
        var end = this.prepareBatchForm.value.ending_serial_no;
    ...
    PrepareBatchComponent.prototype.openDialog = function () {
        ...
        var dialogRef = this.dialog.open(src_app_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AppDialogComponent"], dialogConfig);
        dialogRef.afterClosed().subscribe(function (data) { return console.log(data); });
    };
    PrepareBatchComponent.ctorParameters = function () { return [
...
var ViewBatchComponent = /** @class */ (function () {
    function ViewBatchComponent(batchService, navListService) {
        this.batchService = batchService;
        this.navListService = navListService;
    ...
    ViewBatchComponent.prototype.ngOnInit = function () {
        ...
        this.batchService.getBatchList()
            ...
            var batchesArray = [];
            for (var key in responseData.data.batches) {
                var batch = responseData.data.batches[key];
                var total_cylinders = parseInt(batch.serial_end) - parseInt(batch.serial_start);
                batchesArray.push({
            ...
            _this.dataSource.data = batches;
        });
    };
    ViewBatchComponent.ctorParameters = function () { return [
...
var ModifyRejectionsComponent = /** @class */ (function () {
    function ModifyRejectionsComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
    ...
    ModifyRejectionsComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ModifyRejectionsComponent.prototype.invalidSerialNumber = function () {
        var dialogRef = this.dialog.open(src_app_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AppDialogComponent"], {
            data: {
    ...
    ModifyRejectionsComponent.prototype.onSearchClick = function () {
        if (this.batches.length) {
            var serialno_1 = parseInt(this.searchSerialNoForm.value.serialno);
            var searchBatch = this.batches.find(function (element) {
                if (parseInt(element.serial_start) <= serialno_1 && parseInt(element.serial_end) >= serialno_1) {
                    return element;
                }
            });
    ...
    ModifyRejectionsComponent.prototype.onRejectSubmit = function () {
        var _this = this;
        this.batchService.rejectCylinder(this.modifyRejectionsForm.value).subscribe(function (responseData) {
            var message = "";
            if (responseData.status == "1") {
    ...
    ModifyRejectionsComponent.ctorParameters = function () { return [
        { type: _batch_batch_service__WEBPACK_IMPORTED_MODULE_3__["BatchService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
    ]; };
    ...
    return ModifyRejectionsComponent;
}());
...
var RejectCylindersComponent = /** @class */ (function () {
    function RejectCylindersComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
        this.showRejectForm = false;
        this.batches = [];
    ...
    RejectCylindersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.searchSerialNoForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            serialno: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('')
        });
    ...
    RejectCylindersComponent.prototype.onSearchClick = function () {
        if (this.batches.length) {
            var serialno_1 = parseInt(this.searchSerialNoForm.value.serialno);
            var searchBatch = this.batches.find(function (element) {
                if (parseInt(element.serial_start) <= serialno_1 && parseInt(element.serial_end) >= serialno_1) {
    ...
    RejectCylindersComponent.prototype.onRejectSubmit = function () {
        var _this = this;
        this.batchService.rejectCylinder(this.rejectCylinderForm.value).subscribe(function (responseData) {
            var message = "";
            _this.showRejectForm = false;
            _this.rejectCylinderForm.reset();
            _this.searchSerialNoForm.reset();
            if (responseData.status == "1") {
                message = "Cylinder has been rejected.";
            }
            else if (responseData.status == "2") {
    ...
    RejectCylindersComponent.ctorParameters = function () { return [
        { type: _batch_batch_service__WEBPACK_IMPORTED_MODULE_3__["BatchService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
    ]; };
    ...
    return RejectCylindersComponent;
}());
...
var RejectedCylindersComponent = /** @class */ (function () {
    function RejectedCylindersComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
        this.searchData = [];
    ...
    RejectedCylindersComponent.prototype.ngOnInit = function () {
    ...
    RejectedCylindersComponent.prototype.onSearchClick = function () {
        var _this = this;
        var data = {
        ...
        this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
            if (responseData.status == '1') {
                _this.displayRejectedCylinders = true;
                _this.filterForm.patchValue({
                    filterValue: 'All'
                });
                _this.searchData = _this.dataSource.data = responseData.data.rejectionslist;
                var rejection_types_array = _this.dataSource.data.map(function (element) { return element.rejection_type; });
                rejection_types_array = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](new Set(rejection_types_array));
                _this.rejection_types = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](['All'], rejection_types_array);
                _this.searchBatchNameForm.reset();
            }
            else {
                _this.displayRejectedCylinders = false;
    ...
    RejectedCylindersComponent.prototype.onFilterChange = function () {
        var value = this.filterForm.value.filterValue;
        if (value == 'All') {
            this.dataSource.data = this.searchData;
        }
        else {
            this.dataSource.data = this.searchData.filter(function (element) { return element.rejection_type == value; });
        }
    };
    RejectedCylindersComponent.ctorParameters = function () { return [
        { type: _batch_batch_service__WEBPACK_IMPORTED_MODULE_3__["BatchService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
    ]; };
    ...
    return RejectedCylindersComponent;
}());
...
var HstreportsComponent = /** @class */ (function () {
    function HstreportsComponent(batchService) {
        this.batchService = batchService;
    ...
    HstreportsComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HstreportsComponent.prototype.onGenerateClick = function () {
        var _this = this;
        this.batchName = this.generateReportForm.value.batch_name;
        var data = {
            "batchname": this.batchName
        };
        this.batch = this.batchesList.find(function (element) { return element.batchname == _this.batchName; });
        ...
        this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
            ...
            _this.dataSource.data = _this.batchService.prepareReportDataSource(_this.batch.serial_start, _this.batch.serial_end, "HST", rejectionsList);
            _this.showHSTReport = true;
        });
    };
    HstreportsComponent.ctorParameters = function () { return [
...
var PneumaticreportComponent = /** @class */ (function () {
    function PneumaticreportComponent(batchService) {
        this.batchService = batchService;
        this.showHSTReport = false;
        this.batchesList = [];
        this.batchName = "";
    ...
    PneumaticreportComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.generateReportForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            batch_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('')
        });
    ...
    PneumaticreportComponent.prototype.onGenerateClick = function () {
        var _this = this;
        this.batchName = this.generateReportForm.value.batch_name;
        var data = {
            "batchname": this.batchName
        ...
        this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
            ...
            _this.dataSource.data = _this.batchService.prepareReportDataSource(_this.batch.serial_start, _this.batch.serial_end, "Pneumatic", rejectionsList);
            _this.showHSTReport = true;
        });
    };
    PneumaticreportComponent.ctorParameters = function () { return [
        { type: _batch_batch_service__WEBPACK_IMPORTED_MODULE_4__["BatchService"] }
    ]; };
    ...
    return PneumaticreportComponent;
}());
...
var TareweightComponent = /** @class */ (function () {
    function TareweightComponent(batchService) {
        this.batchService = batchService;
        this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"]();
        this.batchesList = [];
        this.batchName = "";
    }
    TareweightComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    TareweightComponent.prototype.onGenerateClick = function () {
        var _this = this;
        ...
        this.batch = this.batchesList.find(function (element) { return element.batchname == _this.batchName; });
        this.batchService.tareweightCylindersList(data).subscribe(function (responseData) {
            console.log(responseData);
        });
    };
    TareweightComponent.ctorParameters = function () { return [
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(authService, navListService) {
        this.authService = authService;
        this.navListService = navListService;
        this.navList = [];
    }
    ...
    HeaderComponent.prototype.navBarClick = function (nav) {
        nav.disabled = true;
        this.navListService.onNavListChange(nav);
    };
...
var NavListService = /** @class */ (function () {
    ...
    NavListService.prototype.onNavListChange = function (navList) {
        this.navList.map(function (element) {
    ...
    NavListService.prototype.getNavList = function () {
        return this.navList;
    };
